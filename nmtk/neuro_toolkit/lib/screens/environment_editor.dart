...
class _EnvironmentCardState extends ConsumerState<_EnvironmentCard> {
  ...
  Widget _buildPackages(EnvironmentInfo env, Zeta zeta) {
    ...
    if (_packagesError != null) {
      return Text(
        _packagesError!,
        style: ZetaTextStyles.bodySmall.apply(color: zeta.colors.mainNegative),
      );
    }
    ...
    if (pkgs.isEmpty) {
      return Text(
        'No packages found.',
        style: ZetaTextStyles.bodySmall.apply(color: zeta.colors.mainSubtle),
      );
    }
    return Column(
      children: [
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Text('Contents', style: ZetaTextStyles.labelMedium),
                const Spacer(),
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Environment name', style: ZetaTextStyles.labelMedium),
            ...
            const SizedBox(height: 16),
            Text('requirements.txt', style: ZetaTextStyles.labelMedium),
            const SizedBox(height: 6),
            TextField(
