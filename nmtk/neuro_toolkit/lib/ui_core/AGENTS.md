...
- `../../pubspec.yaml` (root's, now shared)
- `../../analysis_options.yaml` (root's, now shared)
...
Constraints:
- `nmtk_ui_core.dart` is the public API barrel; add or remove public models, theme exports, and widgets there intentionally.
