...
mixin _$EnvironmentState {
 ...
 List<EnvironmentInfo> get environments; bool get busy; String? get activeOperation;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EnvironmentState&&const DeepCollectionEquality().equals(other.environments, environments)&&(identical(other.busy, busy) || other.busy == busy)&&(identical(other.activeOperation, activeOperation) || other.activeOperation == activeOperation));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(environments),busy,activeOperation);
...
/// Create a copy of EnvironmentState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? environments = null,Object? busy = null,Object? activeOperation = freezed,}) {
  return _then(_self.copyWith(
environments: null == environments ? _self.environments : environments // ignore: cast_nullable_to_non_nullable
as List<EnvironmentInfo>,busy: null == busy ? _self.busy : busy // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<EnvironmentInfo> environments,  bool busy,  String? activeOperation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EnvironmentState() when $default != null:
return $default(_that.environments,_that.busy,_that.activeOperation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<EnvironmentInfo> environments,  bool busy,  String? activeOperation)  $default,) {final _that = this;
switch (_that) {
case _EnvironmentState():
return $default(_that.environments,_that.busy,_that.activeOperation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<EnvironmentInfo> environments,  bool busy,  String? activeOperation)?  $default,) {final _that = this;
switch (_that) {
case _EnvironmentState() when $default != null:
return $default(_that.environments,_that.busy,_that.activeOperation);case _:
  return null;
...
@override final  String? activeOperation;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EnvironmentState&&const DeepCollectionEquality().equals(other._environments, _environments)&&(identical(other.busy, busy) || other.busy == busy)&&(identical(other.activeOperation, activeOperation) || other.activeOperation == activeOperation));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_environments),busy,activeOperation);
...
/// Create a copy of EnvironmentState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? environments = null,Object? busy = null,Object? activeOperation = freezed,}) {
  return _then(_EnvironmentState(
environments: null == environments ? _self._environments : environments // ignore: cast_nullable_to_non_nullable
as List<EnvironmentInfo>,busy: null == busy ? _self.busy : busy // ignore: cast_nullable_to_non_nullable
as bool,activeOperation: freezed == activeOperation ? _self.activeOperation : activeOperation // ignore: cast_nullable_to_non_nullable
as String?,
  ));
