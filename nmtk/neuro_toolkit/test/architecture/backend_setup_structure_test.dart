...
void main() {
  test('backend_setup has zero part/part-of directives', () {
    final backendSetupDir = Directory('lib/screens/backend_setup');
    final files = <File>[
      File('lib/screens/backend_setup.dart'),
      if (backendSetupDir.existsSync())
        ...backendSetupDir
  ...
  test('backend_setup keeps each public class in its own file', () {
    final backendSetupDir = Directory('lib/screens/backend_setup');
    final files = <File>[
      File('lib/screens/backend_setup.dart'),
      if (backendSetupDir.existsSync())
