  ...
  group('PynqPairedBoard', () {
    test('fromJson parses paired board state', () {
      final json = {
        ...
        'runtimeApiUrlOverride': 'http://198.51.100.60:8002',
      ...
      expect(board.runtimeApiUrlOverride, 'http://198.51.100.60:8002');
    ...
    test('toJson and copyWith preserve runtime API override separately', () {
      ...
      expect(payload['runtimeApiUrlOverride'], 'http://198.51.100.60:8002');
  ...
  group('AkidaPairedHost', () {
    ...
    test('toJson and copyWith preserve simulator-only runtime state', () {
      const host = AkidaPairedHost(
        ...
        username: 'operator',
        runtimeApiUrl: 'http://198.51.100.60:8002',
        controlApiUrl: 'http://198.51.100.60:8091',
