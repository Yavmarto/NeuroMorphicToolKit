...
class TestLauncherHardwareSettings(LauncherControlServiceTestBase):
        ...
        created = self.state.create_akida_host(
            {
                ...
                "host": "203.0.113.90",
                "runtimeApiUrl": "http://203.0.113.90:8002",
                "controlApiUrl": "http://203.0.113.90:8090",
            }
        )

        self.assertEqual(created["runtimeApiUrl"], "http://203.0.113.90:8002")
        self.assertEqual(created["controlApiUrl"], "http://203.0.113.90:8091")
    ...
    def test_pynq_board_round_trip_updates_settings_file(self) -> None:
        ...
        self.assertEqual(persisted["pynqBoards"][0]["host"], "198.51.100.50")
    ...
    def test_pynq_board_defaults_can_come_from_neurochip_manifest_contract(
        ...
        self.assertEqual(created["runtimeApiUrl"], "http://198.51.100.50:9102")
        ...
        secondary = self.state.create_akida_host(
            {
                ...
                "runtimeApiUrl": "http://198.51.100.61:8002",
                "state": "pending",
            }
        )
        ...
        created = self.state.create_pynq_board(
            {
                "displayName": "Desk PYNQ",
                "host": "198.51.100.50",
                "runtimeApiUrl": "http://198.51.100.50:8002",
            }
        )

        self.assertEqual(created["runtimeApiUrl"], "http://198.51.100.50:8002")
        ...
        created = self.state.create_pynq_board(
            {
                "displayName": "Desk PYNQ",
                "host": "198.51.100.50",
                "runtimeApiUrl": "http://198.51.100.99:8002",
            }
        )

        self.assertEqual(created["runtimeApiUrl"], "http://198.51.100.99:8002")
        self.assertEqual(
            created["runtimeApiUrlOverride"],
            "http://198.51.100.99:8002",
        )
    ...
    def test_pynq_board_host_update_recomputes_effective_runtime_url_without_override(
        ...
        self.assertEqual(updated["runtimeApiUrl"], "http://203.0.113.53:8002")
        ...
        board = self.state.create_pynq_board(
            {
                "displayName": "Desk PYNQ",
                "host": "203.0.113.50",
                "runtimeApiUrlOverride": "http://203.0.113.99:8002",
            }
        )
