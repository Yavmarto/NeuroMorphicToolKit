"""Run contract CI phases from a module.json manifest.

Wraps each command in GitHub Actions ::group:: markers for collapsible
log sections.  Can be run locally or from a workflow.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run contract CI phases from a module.json manifest.",
    )
