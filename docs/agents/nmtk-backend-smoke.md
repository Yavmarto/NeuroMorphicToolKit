...
For the shared development host, set `NMTK_BACKEND_HOST=192.168.2.90` so worker
ports resolve there and set `SUITE_API_URL=http://192.168.2.90:9000` for Suite API.
