...
class CustomerMetricCard extends StatelessWidget {
  const CustomerMetricCard({super.key, required this.value, required this.label, required this.change});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            width: 48, height: 48,
            decoration: const ShapeDecoration(color: Colors.white, shape: OvalBorder(side: BorderSide(width: 2, color: Color(0xFFE9ECF2)))),
          ),
          ...
          Column(
            ...
            spacing: 8,
            children: [
              SizedBox(width: 219, child: Text(label, style: const TextStyle(color: Color(0xFF808D9E), fontSize: 14, fontFamily: 'Inter', fontWeight: FontWeight.w400, height: 1.57, letterSpacing: -0.50))),
