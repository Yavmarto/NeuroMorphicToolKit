      ...
      child: Column(
        ...
        children: [
          ...
          TransactionRow(
            ...
            time: '2 hours ago', amount: '+ \$1,839.67', positive: false,
          ),
          Container(
            ...
            child: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text('See All Transaction', style: TextStyle(color: Color(0xFFE9ECF2), fontSize: 16, fontFamily: 'Inter', fontWeight: FontWeight.w700, height: 1.25)),
            ]),
          ),
        ],
      ),
