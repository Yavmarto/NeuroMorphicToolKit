...
/// Small tracker stat tile (icon + value + label) used in the metrics grid.
class TrackerSmallStatCard extends StatelessWidget {
  const TrackerSmallStatCard({super.key, required this.value, required this.label, required this.iconBg});
