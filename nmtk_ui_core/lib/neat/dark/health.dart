  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        TempLogRow(
          level: 'Normal',
          levelColor: Color(0xFF2180FF),
          levelBg: Color(0x190062FF),
        ),
        SizedBox(height: 16),
        Text(
          'Aug 23, 2022',
        ...
        TempLogRow(
          level: 'High',
          levelColor: Color(0xFFFF5555),
          levelBg: Color(0x19FF0000),
        ),
        SizedBox(height: 16),
        Text(
          'Aug 24, 2022',
        ...
        TempLogRow(
          level: 'Medium',
          levelColor: Color(0xFFFFC14B),
          levelBg: Color(0x19FFC24B),
        ),
      ],
    );
  }
