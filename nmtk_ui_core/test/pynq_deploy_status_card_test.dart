...
void main() {
  group('PynqSupportStateCard', () {
    testWidgets('renders exportable state with correct label',
      ...
      expect(
        find.text('Exportable — overlay package ready'),
        findsOneWidget,
      );
    ...
    testWidgets('renders exportable_with_warnings state',
      ...
      expect(
        find.text('Exportable — near capacity limits'),
        findsOneWidget,
      );
      expect(find.byIcon(Icons.warning_amber_rounded), findsOneWidget);
      expect(
        find.textContaining('52429/65536 neurons'),
        findsOneWidget,
      );
    });
    ...
    testWidgets('renders not_exportable state with rejections',
      ...
      expect(
        find.text('Not Exportable — see rejections'),
        findsOneWidget,
      );
