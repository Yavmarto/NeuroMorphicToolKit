...
void main() {
  group('ResponsiveScaffold', () {
    ...
    testWidgets('renders Mobile layout (< 600px) with NavigationBar', (tester) async {
    ...
    testWidgets('renders Tablet layout (600px <= w < 1240px) with NmtkNavigationRail', (tester) async {
    ...
    testWidgets('renders Desktop layout (>= 1240px) with Custom Drawer', (tester) async {
