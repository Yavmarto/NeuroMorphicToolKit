...
#
# Default target server: 192.168.2.90 (moosebun2@192.168.2.90)
#
# Usage:
...
#   scripts/check_dev_server.sh 192.168.2.90
#   scripts/check_dev_server.sh moosebun2@192.168.2.90 --check-only

set -euo pipefail

DEFAULT_IP="192.168.2.90"
DEFAULT_USER="moosebun2"
TARGET_HOST=""
CHECK_ONLY=false
RESTART_ALL=false
PROBE_TIMEOUT=5
