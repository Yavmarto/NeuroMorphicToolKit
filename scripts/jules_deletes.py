...
if not API_KEY:
    print("Error: Please set the JULES_API_KEY environment variable in a .env file or export it.")
    sys.exit(1)
...
def main():
    ...
    batch_input = input("How many of the oldest sessions would you like to delete? (Enter a number, 'all', or '0' to cancel): ").strip().lower()
    ...
    confirm = input(f"Are you sure you want to permanently delete the oldest {limit} session(s)? (y/N): ")
