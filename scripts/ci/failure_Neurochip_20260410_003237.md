...
E           /Users/yoshimartodihardjo/NeuroMorphicToolKit/Neurochip/neurochip/contracts/deployment_contracts.py:55
E           /Users/yoshimartodihardjo/anaconda/anaconda3/lib/python3.12/enum.py:1294
...
neurochip/tests/properties/test_contract_properties.py::test_deployment_manifest_firmware_semver:
  ...
  - during generate phase (0.10 seconds):
    ...
    - 100 passing examples, 1 failing examples, 0 invalid examples
  ...
  - during shrink phase (0.07 seconds):
    ...
    - 51 passing examples, 3 failing examples, 0 invalid examples
    - Tried 54 shrinks of which 2 were successful
...
neurochip/tests/properties/test_deployment_properties.py::test_analyzer_neuron_invariant:
  ...
  - during generate phase (0.39 seconds):
    - Typical runtimes: ~ 1-4 ms, of which ~ 0-4 ms in data generation
    - 100 passing examples, 0 failing examples, 3 invalid examples
    - Events:
      * 26.21%, Retried draw from text(characters(codec='utf-8')).filter(not_yet_in_unique_list) to satisfy filter
...
neurochip/tests/properties/test_pynq_runtime_properties.py::TestPynqRuntimeProperties::test_output_spikes_are_valid_neuron_indices:
  ...
  - during generate phase (0.06 seconds):
    - Typical runtimes: ~ 0-1 ms, of which < 1ms in data generation
    - 50 passing examples, 0 failing examples, 5 invalid examples
...
neurochip/tests/properties/test_pynq_runtime_properties.py::TestPynqRuntimeProperties::test_reset_clears_weights:
  ...
  - during generate phase (0.03 seconds):
    ...
    - 30 passing examples, 0 failing examples, 4 invalid examples
...
=================== 1 failed, 243 passed, 1 skipped in 5.61s ===================
```
