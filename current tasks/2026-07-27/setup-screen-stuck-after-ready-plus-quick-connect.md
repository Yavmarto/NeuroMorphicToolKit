...
REMOTE_HOST=moosebun2@192.168.2.90`); the pasted log tail ended with
...
flagged for the user to confirm against `moosebun2@192.168.2.90` on next
deploy.
...
then use "Already have a server running?" to connect to `192.168.2.90`
directly.
